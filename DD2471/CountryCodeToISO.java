 ...
 * In addition, there are static methods to get a {@code CountryCodeToISO} instance that
 ...
 * for (CountryCodeToISO code : CountryCodeToISO.values())
 * {
 ...
 * }
 *
 * <span style="color: darkgreen;">// Get a CountryCodeToISO instance by ISO 3166-1 code.</span>
 * CountryCodeToISO code = CountryCodeToISO.{@link #getByCode(String) getByCode}(<span style="color: darkred;">"JP"</span>);
 *
 ...
 *
 * <span style="color: darkgreen;">// Get a CountryCodeToISO by a Locale instance.</span>
 * code = CountryCodeToISO.{@link #getByLocale(Locale) getByLocale}(locale);
 *
 ...
 * //
 * //     CountryCodeToISO.AE : United Arab Emirates
 * //     CountryCodeToISO.GB : United Kingdom
 * //     CountryCodeToISO.TZ : Tanzania, United Republic of
 * //     CountryCodeToISO.UK : United Kingdom
 * //     CountryCodeToISO.UM : United States Minor Outlying Islands
 * //     CountryCodeToISO.US : United States
 * //</span>
 * List&lt;CountryCodeToISO&gt; list = CountryCodeToISO.{@link #findByName(String) findByName}(<span style="color: darkred;">".*United.*"</span>);
 * </pre>
 *
...
public enum CountryCodeToISO
{
    ...
    /**
     * Convert this {@code CountryCodeToISO} instance to a {@link Locale} instance.
     *
     * <p>
     * In most cases, this method creates a new {@code Locale} instance
     * every time it is called, but some {@code CountryCodeToISO} instances return
     * their corresponding entries in {@code Locale} class. For example,
     * {@link #CA CountryCodeToISO.CA} always returns {@link Locale#CANADA}.
     * </p>
     *
     * <p>
     * The table below lists {@code CountryCodeToISO} entries whose {@code toLocale()}
     ...
     * <tr bgcolor="#FF8C00">
     *   <th>CountryCodeToISO</th>
     *   <th>Locale</th>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#CA CountryCodeToISO.CA}</td>
     *   <td>{@link Locale#CANADA}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#CN CountryCodeToISO.CN}</td>
     *   <td>{@link Locale#CHINA}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#DE CountryCodeToISO.DE}</td>
     *   <td>{@link Locale#GERMANY}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#FR CountryCodeToISO.FR}</td>
     *   <td>{@link Locale#FRANCE}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#GB CountryCodeToISO.GB}</td>
     *   <td>{@link Locale#UK}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#IT CountryCodeToISO.IT}</td>
     *   <td>{@link Locale#ITALY}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#JP CountryCodeToISO.JP}</td>
     *   <td>{@link Locale#JAPAN}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#KR CountryCodeToISO.KR}</td>
     *   <td>{@link Locale#KOREA}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#TW CountryCodeToISO.TW}</td>
     *   <td>{@link Locale#TAIWAN}</td>
     * </tr>
     * <tr>
     *   <td>{@link CountryCodeToISO#US CountryCodeToISO.US}</td>
     *   <td>{@link Locale#US}</td>
     * </tr>
     * </table>
     *
     * @return
     *         A {@code Locale} instance that matches this {@code CountryCodeToISO}.
     */
    public Locale toLocale()
    {
     ...
     * this {@code CountryCodeToISO} instance does not have a currency.
     * {@link #AQ} (Antarctica) is one example.
     * </p>
     *
     * <p>
     * In addition, this method returns {@code null} also when the ISO 3166
     * code represented by this {@code CountryCodeToISO} instance is not
    ...
    /**
     * Get a {@code CountryCodeToISO} that corresponds to the given ISO 3166-1
     ...
     *
     * @return
     *         A {@code CountryCodeToISO} instance, or {@code null} if not found.
     *
     ...
     *         {@code getByCode("jp", false)} returns {@link #JP CountryCodeToISO.JP}.
     *
     * @return
     *         A {@code CountryCodeToISO} instance, or {@code null} if not found.
     */
    ...
    /**
     * Get a {@code CountryCodeToISO} that corresponds to the country code of
    ...
    /**
     * Get a {@code CountryCodeToISO} that corresponds to the given
    ...
    /**
     * Get a list of {@code CountryCodeToISO} by a name regular expression.
     *
     * <p>
     ...
     *
     * @return
     *         List of {@code CountryCodeToISO}. If nothing has matched,
    ...
    /**
     * Get a list of {@code CountryCodeToISO} by a name pattern.
     *
     * <p>
     ...
     * List&lt;CountryCodeToISO&gt; list = CountryCodeToISO.findByName(pattern);</pre>
     *
     * <p>
     * contains 6 {@code CountryCodeToISO}s as listed below.
     * </p>
     *
     * <ol>
